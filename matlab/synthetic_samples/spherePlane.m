function S = spherePlane(num_spheres,Box_Dims,radius)
...
rng(0,'twister');
rnd_x = randi([-128,128],1,num_spheres*10000);
rnd_y = randi([-128,128],1,num_spheres*10000);
rnd_z = 0;
...
matches = 1;
good_x = (zeros(num_spheres));
good_x(1) = rnd_x(1);
good_y = (zeros(num_spheres));
good_y(1) = rnd_y(1);
good_z = rnd_z;
rnd_idx = 2;
